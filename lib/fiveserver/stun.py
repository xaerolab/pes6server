...
XOR_MAPPED_ADDRESS = 0x8020  # No estÃ¡ndar, pero usado en algunos servidores CLASSIC-STUN
...
class STUNServer(DatagramProtocol):
    ...
    def create_binding_response(self, addr, transaction_id):
        ...
        # XOR-MAPPED-ADDRESS (IP/puerto XOR con un valor fijo, comÃºn en CLASSIC-STUN)
...
def start_stun_server():
    # Configura tu IP publica o local aqui
